...
controller_base::controller_base()
    ...
    trajectory_pub_ = nh_.advertise<nav_msgs::Path>("path_visualisation", 10);
...
void controller_base::vehicle_state_callback(const rosplane_msgs::StateConstPtr& msg) {
    ...
    pose.pose.orientation.w = msg->quat[0];
    pose.pose.orientation.x = msg->quat[1];
    pose.pose.orientation.y = msg->quat[2];
    pose.pose.orientation.z = msg->quat[3];
